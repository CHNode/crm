	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
			...
			<div class="col-sm-10" style="width: 300px;">
			  <select class="form-control" id="create-stage" name="stage">
			  	...
			  	<c:forEach items="${stage}" var="s">
					<option id="${s.id}" value="${s.value}" >${s.text}</option>
				</c:forEach>
			  </select>
			</div>
		</div>
			...
			<div class="col-sm-10" style="width: 300px;">
				<select class="form-control" id="create-transactionType" name="type">
				  ...
				  <c:forEach items="${transactionType}" var="tt">
					  <option id="${tt.id}" value="${tt.value}">${tt.text}</option>
				  </c:forEach>
				</select>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="activityId" value="c7c2cbcab4194a9d8bfeb5ac60ac2ad9">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="bd58f3a066b94efea50aabdd2fe70ecf">
			</div>
		</div>
